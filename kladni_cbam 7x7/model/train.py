...
from datetime import timedelta  # Format seconds as HH:MM:SS for readability
# ======================
# Local imports
# ======================
from dataset import ChladniDataset
from network import BasicCNN_CBAM
...
def main():
    ...
    # ===== Model and optimizer =====
    model = BasicCNN_CBAM(num_classes=15).to(DEVICE)  
    ...
    for epoch in range(EPOCHS):
        ...
        # Compute current epoch duration
        epoch_end = time.time()
        epoch_duration = epoch_end - epoch_start
        epoch_times.append(epoch_duration)
        # Format as HH:MM:SS (e.g. 0:01:23 = 1 min 23 sec)
    ...
    # Print total and average epoch duration
